...
function Sccuesscontect() {
  ...
  <div className='container'>
   ...
   <h2 className='text-center download'>your information is sent successfully we will contact with you.  </h2>
  <h6 className='text-center mt-4'>please see your gmail or your whats app to see when we contact with you</h6>
