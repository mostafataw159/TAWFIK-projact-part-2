...
function Sccuesssign() {
  ...
  <div className='container'>
   ...
   <h2 className='text-center download'>you are signed in successfully you now get 15$ discount for your next order:)  </h2>
  <h6 className='text-center mt-4'>go and order now a lot of games to be happy with your discount.</h6>
